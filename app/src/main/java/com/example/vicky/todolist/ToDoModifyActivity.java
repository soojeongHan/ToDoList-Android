    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dateView_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ToDoModifyActivity.this, CalendarActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.menu_check:
                dbHandler.updateToDoModify(todoId, headerView_edit.getText().toString(), dateView_edit.getText().toString(), contentView_edit.getText().toString());
                finish();
                ta.finish();
                Intent intent = new Intent(ToDoModifyActivity.this, ToDoReadActivity.class);
                intent.putExtra(INTENT_TODO_ID, todoId);
